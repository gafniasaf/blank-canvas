...
var outPath = Folder.desktop.fsName + "/debug_find_aerobe_bullet_" + isoStamp() + ".txt";
...
for (var s = 0; s < doc.stories.length; s++) {
  ...
  for (var p = 0; p < pc; p++) {
    ...
    var isAerobeBullet = (low.indexOf('aerobe dissimilatie.') === 0 || low.indexOf('aerobe dissimilatie:') === 0) && (low.indexOf('bij dit proces') !== -1);
    if (!isAerobeBullet) continue;
