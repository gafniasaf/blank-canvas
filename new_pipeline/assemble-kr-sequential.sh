...
TMP1="$OUT/_tmp_kr_book_1.json"
TMP2="$OUT/_tmp_kr_book_2.json"

FINAL_JSON="$OUT/klinisch_redeneren_full_rewritten.json"
FINAL_PDF="$OUT/klinisch_redeneren_FINAL.pdf"
FINAL_LOG="$OUT/klinisch_redeneren_prince.log"

echo "Assembling Klinisch redeneren sequentially (no duplicated chapters)..."
