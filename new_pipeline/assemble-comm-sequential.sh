...
TMP1="$OUT/_tmp_comm_book_1.json"
TMP2="$OUT/_tmp_comm_book_2.json"

FINAL_JSON="$OUT/communicatie_full_rewritten.json"
FINAL_PDF="$OUT/communicatie_FINAL.pdf"
FINAL_LOG="$OUT/communicatie_prince.log"

echo "Assembling Communicatie sequentially (no duplicated chapters)..."
