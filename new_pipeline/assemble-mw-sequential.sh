...
TMP1="$OUT/_tmp_mw_book_1.json"
TMP2="$OUT/_tmp_mw_book_2.json"

FINAL_JSON="$OUT/methodisch_werken_full_rewritten.json"
FINAL_PDF="$OUT/methodisch_werken_FINAL.pdf"
FINAL_LOG="$OUT/methodisch_werken_prince.log"

echo "Assembling Methodisch werken sequentially (no duplicated chapters)..."
