...
npx tsx scripts/merge-assembled-chapters.ts "$OUT" "$OUT/wetgeving_full_rewritten.json"

# Render PDF
echo "Rendering PDF..."
npx tsx renderer/render-prince-pdf.ts "$OUT/wetgeving_full_rewritten.json" "$OUT/wetgeving_FINAL.pdf"

echo "Done! PDF at: $OUT/wetgeving_FINAL.pdf"
